...
macro_rules! keys {
    ( $( $(#[$meta:meta])* $variant:ident $arity:literal ),* $(,)? ) => {
        ...
        impl Key {
            /// Number of `{}` placeholders in this key's English text, declared
            /// beside the key. Every [`t_fmt`] call site is written against this
            /// count, and the corpus lint compares it with the English text, so
            /// a wording change that adds or drops a placeholder cannot move the
            /// count silently.
...
keys! {
    ...
    AddKvRow 0,
    InvalidJson 1,
    RuntimeChannelClosed 0,
    WorkerExitedWithoutResult 0,
    InvalidGoDuration 0,
    InvalidGoDurationShort 0,
    WaitingForXray 0,
    WaitingForXrayEllipsis 0,
    ...
    CoreSetupDownloading 0,
    CoreSetupFailed 0,
    CoreSetupInstalled 0,
    CoreSetupNotInstalled 0,
    CoreSetupUpdateRequired 0,
    ...
    CoreSetupOpenReleaseHint 0,
    CoreSetupArchiveSep 1,
    CoreSetupCopyLink 0,
    CoreSetupStopFirst 0,
    CoreSetupBusy 0,
    ...
    CoreSetupContinue 0,
    CoreSetupContinueDisabled 0,
    CoreSetupFailedError 1,
    CoreSetupSetUpLater 0,
    CoreSetupLaterDisabled 0,
    LatencyRequiresProfile 0,
    LatencyCoreUnavailable 0,
    LatencyFeedbackComplete 1,
    LatencyFeedbackPartial 2,
    LatencyFeedbackFailed 1,
    LatencyProbeOneResponded 2,
    LatencyProbeOneDead 1,
    LatencyProbeOneFailed 2,
    LatencyProbeOneDeadReason 2,
    LatencyProbeOneDeadAt 2,
    LatencyProbeOneDeadAtReason 3,
    LatencyFeedbackPartialWarn 2,
    ...
    TopbarChangesPending 0,
    TopbarServerEditsUnsaved 0,
    TopbarApplyNow 0,
    ApplyResultOk 0,
    ApplyResultFailed 0,
    TopbarConfigInvalid 0,
    TopbarSettingsNotSaved 0,
    TopbarRetrySave 0,
    ...
    ApplyResultUnsaved 2,
    ApplyResultOlder 1,
    RollbackRestored 1,
    RollbackFailed 1,
    ConnectBlockedSave 1,
    ConnectBlockedRawMode 0,
    ConnectBlockedInstallCore 0,
    ConnectBlockedCoreUpdate 2,
    ConnectBlockedOperation 1,
    GenerationFailed 1,
    CoreRuntimeUnavailable 0,
    StateFileLoadFailed 2,
    ApplyBlockedNotSaved 1,
    ApplyBlockedOperation 1,
    RawOverrideOffMode 0,
    RawOverrideDefineApi 0,
    RawOverrideStatsService 0,
    RawOverrideNoTun 0,
    // Tray tooltip (icon presentation).
    IconTooltipError 0,
    IconTooltipCoreRunning 0,
    IconTooltipTun 0,
    // First-run wizard.
    WizardWelcome 0,
    WizardCoreMissing 0,
    ...
    AboutTagline 0,
    AboutCoreVersion 1,
    AboutCoreNotInstalled 0,
    AboutUpstreamLink 0,
    AboutRepoLink 0,
    AboutLicenses 0,
    AboutLicenseXray 0,
    AboutLicenseWintun 0,
    AboutLicenseTexts 1,
    AboutBuiltWith 0,
    // TUN screen.
    TunBadgeElevated 0,
    TunBadgeNotElevated 0,
    TunBadgeHelperActive 0,
    TunExplain 0,
    ...
    DashboardLocalEndpoints 0,
    DashboardEndpointHint 0,
    LocalStatusUp 0,
    LocalStatusDown 0,
    LocalStatusDisabled 0,
    LocalStatusStarting 0,
    TunStatusActive 0,
    TunStatusElevation 0,
    TunStatusOff 0,
    EndpointRow 3,
    TunStatus 1,
    DashboardTunHoverElevated 0,
    DashboardTunHoverNotElevated 0,
    DashboardActiveServer 0,
    NoneSelected 0,
    DashboardRateUp 1,
    DashboardRateDown 1,
    DashboardUptime 1,
    DashboardGoroutines 1,
    DashboardNoStatsStarting 0,
    DashboardNoStatsRunning 0,
    DashboardNoStatsStopped 0,
    DashboardNoStatsBackoff 0,
    DashboardNoStatsError 0,
    DashboardPlotSecondsAgo 0,
    DashboardPlotBytesPerSec 0,
    PlotUp 0,
    PlotDown 0,
    DashboardNoServers 0,
    GridName 0,
    GridTag 0,
    GridLatency 0,
    GridDetail 0,
    HealthPingSummary 6,
    DashboardDownloadProgress 3,
    DashboardDownloadFailed 1,
    ConnectUnavailable 0,
    DashboardPhaseStopped 0,
    DashboardPhaseStarting 0,
    DashboardPhaseRunning 0,
    DashboardPhaseRetry 1,
    DashboardPhaseError 0,
    DashboardOpenCoreSetup 0,
    // Logs screen.
    LogsLevelAll 0,
    LogsLevelInfoPlus 0,
    LogsLevelWarningPlus 0,
    LogsLevelErrorPlus 0,
    LogsLevelLabel 0,
    LogsFilterLabel 0,
    LogsFilterHint 0,
    LogsAutoscroll 0,
    ...
    LogsClearViewHint 0,
    LogsOpenFolder 0,
    LogsOpenFolderFailed 1,
    LogsRestartLogger 0,
    LogsRestartLoggerHint 0,
    LogsRestartDisabledNotRunning 0,
    LogsRestartDisabledBusy 0,
    LogsRestarting 0,
    LogsLineCount 2,
    LogsRestartFeedbackOk 0,
    // Profile preview screen.
    PreviewNoLaunch 0,
    PreviewCredentialsWarning 0,
    PreviewActiveConfig 0,
    PreviewLoadFailed 1,
    PreviewPhaseStarting 0,
    PreviewPhaseRunning 0,
    PreviewPhaseBackoff 0,
    PreviewPhaseStopped 0,
    // DNS screen.
    DnsSectionServers 0,
    DnsPriorityHint 0,
    DnsMoveUp 0,
    ...
    DnsQueryStrategy 0,
    DnsDisableCache 0,
    DnsDisableFallback 0,
    DnsDisableFallbackIfMatched 0,
    DnsSkipFallbackHint 0,
    DnsServeStale 0,
    DnsServeStaleHint 0,
    DnsParallelQueries 0,
    DnsUseSystemHosts 0,
    ...
    DnsPoolCidrInvalid 0,
    DnsPoolSize 0,
    DnsAddPool 0,
    DnsAddress 0,
    DnsAddressHint 0,
    DnsAddressRequired 0,
    DnsPort 0,
    DnsDomains 0,
    DnsDomainsHint 0,
    DnsExpectedIps 0,
    DnsExpectedIpsHint 0,
    DnsUnexpectedIps 0,
    DnsUnexpectedIpsHint 0,
    DnsClientIpOverride 0,
    DnsTagOutbound 0,
    DnsSkipFallback 0,
    DnsFinalQuery 0,
    DnsTimeoutRequired 0,
    DnsTimeoutInteger 0,
    DnsTimeoutRange 0,
    DnsTimeoutMs 0,
    DnsTimeoutHint 0,
    ...
    BoolTrue 0,
    // Inbounds screen.
    InboundsPostureWarn 0,
    InboundsListenAddress 0,
    InboundsUdpSupport 0,
    InboundsUdpRelayIp 0,
    InboundsUdpRelayIpHint 0,
    InboundsUdpWildcardHint 0,
    InboundsRequireAuth 0,
    ...
    // English text.
    InboundsAuthRequiresAccounts 0,
    InboundsSectionDokodemo 0,
    InboundsStableTagHint 0,
    InboundsDeleteDokodemo 0,
    ...
    InboundsPortMap 0,
    InboundsAddPortMapping 0,
    InboundsAddDokodemo 0,
    InboundsListener 0,
    InboundsModeTcp 0,
    InboundsModeUdp 0,
    InboundsModeTcpUdp 0,
    InboundsPreserveImported 1,
    InboundsPreserveImportedHint 0,
    InboundsImportedUnsupported 2,
    ListenerLabelSocks 0,
    ListenerLabelHttp 0,
    ListenerLabelDokodemo 1,
    // Local listeners list: user-managed SOCKS/HTTP endpoints.
    LocalListeners 0,
    AddSocks 0,
    AddHttp 0,
    RemoveEndpoint 0,
    EndpointProtocolSocks 0,
    EndpointProtocolHttp 0,
    EmptyLocalListeners 0,
    // Safety warnings (hazard taxonomy).
    SafetySocksListenerExposed 1,
    SafetyHttpListenerExposed 1,
    ...
    SafetyAckApplyAnyway 0,
    CollisionInvalidNetwork 2,
    CollisionNeedsPort 1,
    CollisionNeedsUnix 1,
    CollisionEndpoint 1,
    CollisionConflict 3,
    DokodemoTagMissing 0,
    DokodemoTagBuiltin 1,
    DokodemoTagDuplicate 1,
    Accounts 0,
    AccountUserHint 0,
    AccountPasswordHint 0,
    AddAccount 0,
    SniffingSection 0,
    SniffingDestOverride 0,
    SniffingFakednsHint 0,
    SniffingDomainsExcluded 0,
    SniffingIpsExcluded 0,
    SniffingMetadataOnly 0,
    SniffingRouteOnly 0,
    // Routing screen.
    GeodataAddGeosite 0,
    GeodataAddGeoip 0,
    RoutingRulesSection 0,
    RoutingMoveUp 0,
    RoutingMoveDown 0,
    RoutingDeleteRule 0,
    RoutingEditRule 0,
    RoutingNoTarget 0,
    RoutingTargetArrow 1,
    RoutingNoRules 0,
    RoutingAddRule 0,
    RuleTag 0,
    RuleTagHint 0,
    ...
    Outbound 0,
    Balancer 0,
    BalancerNeededHint 0,
    NoBalancers 0,
    UseDirect 0,
    GeodataLoaderFailed 1,
    GeodataLoaderStopped 0,
    GeodataLoading 0,
    GeodataRefresh 0,
    GeodataRefreshBusy 0,
    GeodataReading 0,
    GeodataCodesBytes 2,
    GeodataModified 2,
    GeodataModifiedUnavailable 0,
    GeodataSearch 0,
    GeodataNoMatches 0,
    ...
    PrincipleTargets 1,
    PrincipleTargetsNone 0,
    PrincipleTargetsHidden 0,
    RuntimeStateNotRefreshed 0,
    CoreNotRunningControls 0,
    RefreshRuntimeState 0,
    KnownOutbound 0,
    CustomExactTag 0,
    ExactOutboundTag 0,
    ApplyTarget 0,
    ApplyTargetDisabledEmpty 0,
    ApplyTargetDisabledBusy 0,
    ClearOverride 0,
    BalancersSection 0,
    Untagged 0,
    BalancerStrategy 1,
    ...
    BalancerUsedBy 1,
    EditBalancer 0,
    BalancerDeleteBlocked 1,
    AddBalancer 0,
    AddBalancerDisabled 0,
    Tag 0,
    BalancerNameHint 0,
    TagRequired 0,
    TagDuplicate 0,
    ...
    BaselinesHint 0,
    MaxRtt 0,
    InvalidGoDurationExample 0,
    ExpectedNodes 0,
    ExpectedSpeedMode 0,
    Tolerance 0,
    Auto 0,
    ObservabilitySection 0,
    DomainStrategy 0,
    ObservatoryLatencyProbing 0,
    ObservatoryEmitted 0,
    ObservatoryForcedByBalancer 0,
    BurstObservatoryHint 0,
    BurstObservatoryGated 0,
    HealthEngineConflict 0,
    ProbeInterval 0,
    ProbeIntervalHint 0,
    ProbeIntervalHint2 0,
    SubjectSelectors 0,
    SubjectSelectorsHint 0,
    ProbeUrl 0,
    EnableConcurrency 0,
    BurstObservatory 0,
    Destination 0,
    ConnectivityCheck 0,
    ConnectivityCheckHint 0,
    Interval 0,
    IntervalHint 0,
    Sampling 0,
    Timeout 0,
    ...
    TestAttrKeyHint 0,
    TestAttrValueHint 0,
    TestCoreNotRunning 0,
    TestExactContext 0,
    TestDisabledNotRunning 0,
    TestDisabledBusy 0,
    TestDisabledPending 0,
    TestDisabledIncomplete 0,
    AttributeKeyRequired 0,
    DuplicateAttributeKey 1,
    Any 0,
    RuleSummaryDomain 1,
    RuleSummaryIp 1,
    RuleSummaryPort 1,
    ...
    RuleSummaryIn 1,
    RuleSummaryProc 1,
    RuleSummaryMatchAll 0,
    RuleTargetBalancer 1,
    // Settings screen.
    ...
    SettingsLogLevel 0,
    SettingsAccessLog 0,
    SettingsAccessLogHint 0,
    SettingsEnvVars 0,
    SettingsPolicyLevels 0,
    SettingsUserLevel 1,
    SettingsRemoveLevel 0,
    SettingsAddUserLevel 0,
    SettingsUpdates 0,
    SettingsCheckForUpdates 0,
    SettingsCheckForUpdatesHint 0,
    SettingsUpdateChecking 0,
    SettingsUpdateDetected 1,
    ...
    SettingsValidateWithCore 0,
    SettingsValidateHint 0,
    SettingsEnableOverride 0,
    SettingsEnableOverrideHint 0,
    SettingsDisableOverride 0,
    SettingsCoreAccepts 0,
    SettingsCoreRejects 0,
    SettingsTimeoutsHeader 0,
    SettingsHandshake 0,
    SettingsConnIdle 0,
    SettingsUplinkOnly 0,
    SettingsDownlinkOnly 0,
    SettingsBufferSize 0,
    SettingsStatsUserUplink 0,
    SettingsStatsUserDownlink 0,
    SettingsStatsUserOnline 0,
    ProbeIntervalPositive 0,
    ...
    SettingsGeodataProvenanceUserUnknown 0,
    SettingsGeodataRestore 0,
    SettingsGeodataRestoreHint 0,
    SettingsGeodataRestoreBusy 0,
    SettingsGeodataRestoreDone 0,
    SettingsGeodataRestoreFailed 1,
    SettingsGeodataRestoreWorkerFailed 1,
    GeodataUrlNotHttps 0,
    GeodataCronNotFiveFields 0,
    ...
    SrvWgKey 0,
    SrvCertPinHex 0,
    SrvVlessEncryptionRequired 0,
    SrvVlessEncryptionFormat 0,
    SrvAddressRequired 0,
    SrvPortRequired 0,
    SrvManagedCoreVerificationFailed 1,
    SrvLaunchXrayFailed 1,
    SrvCollectOutputFailed 1,
    SrvXrayExited 3,
    SrvReapTimedOutFailed 1,
    SrvXrayDeadline 3,
    SrvWaitXrayFailed 2,
    SrvValidationAlreadyRunning 0,
    SrvNoProfilesToValidate 0,
    SrvDraftValidationRequiresIdentity 0,
    SrvScratchConfigDirFailed 1,
    SrvScratchConfigSerializeFailed 1,
    SrvScratchConfigWriteFailed 1,
    SrvXrayTestSilent 0,
    SrvDuplicateAcceptedId 1,
    SrvWorkerExitedWithoutResult 0,
    SrvDiscardedMismatchedResult 0,
    SrvDiscardedStaleImport 0,
    SrvDraftValidationWithoutIdentity 0,
    SrvXrayRejectedServer 0,
    SrvServerValidatedAndAdded 0,
    SrvServerDeletedWhileValidating 0,
    SrvServerValidatedAndSaved 0,
    SrvImportedCount 1,
    SrvImportOutcome 2,
    SrvAnotherToolRunning 0,
    SrvSpawnToolFailed 1,
    SrvStartValidationFailed 1,
    SrvToolStoppedWithoutResult 0,
    SrvUuidInvalid 0,
    SrvUuidTargetNoId 0,
    SrvUuidGenerated 0,
    SrvToolTargetFieldNotFound 0,
    SrvVlessencInvalid 0,
    SrvVlessencTargetFieldNotFound 0,
    SrvClientEncryptionGenerated 0,
    SrvVlessencNoValue 0,
    SrvWgInvalidPrivateKey 0,
    SrvWgCouldNotParse 0,
    SrvWgSecretGenerated 0,
    SrvWgTargetFieldNotFound 0,
    SrvMldsa65InvalidKey 0,
    SrvMldsa65CouldNotParse 0,
    SrvMldsa65Generated 0,
    SrvMldsa65TargetFieldNotFound 0,
    SrvTlsPinMalformed 0,
    SrvTlsPinNoHash 0,
    SrvTlsPinComputedLeaf 1,
    SrvTlsPinComputed 0,
    SrvTlsPinTargetFieldNotFound 0,
    SrvTlsHandshakeSucceeded 0,
    SrvTlsProbeNoHandshake 1,
    SrvRealityPubKeyDerived 0,
    SrvRealityTargetFieldNotFound 0,
    SrvX25519InvalidPublicKey 0,
    SrvX25519CouldNotParse 0,
    // Servers screen: list + editor chrome.
    SrvAddServer 0,
    SrvImportLinks 0,
    SrvTestLatencyHint 0,
    SrvProbeServerLatencyHint 0,
    SrvLatencyTestAlreadyRunning 0,
    SrvAnotherOperationWorking 0,
    SrvAddServerBeforeLatency 0,
    SrvTestingLatencyIsolated 0,
    SrvSortByLatency 0,
    SrvDragToReorder 0,
    SrvSetActive 0,
    SrvDuplicate 0,
    ...
    SrvDeleteEllipsis 0,
    SrvCopySuffix 1,
    SrvLinkCopiedToClipboard 0,
    SrvExportFailed 1,
    SrvUnnamed 0,
    SrvSelectServerOrAdd 0,
    SrvPrepareDraftFailed 1,
    SrvFixBeforeValidate 0,
    SrvConfigurationWarningsHeader 0,
    SrvValidateAndSave 0,
    ...
    SrvCompleteRequired 0,
    SrvWaitCoreOperation 0,
    SrvValidateAndAdd 0,
    SrvValidateAndAddHint 0,
    SrvKeygenDraftOnly 0,
    SrvDeleteCannotUndone 1,
    SrvCannotDeleteReferences 2,
    SrvDerive 0,
    SrvDerivingXray 0,
    SrvPrivateKeyRequired 0,
    SrvPrivateKeyLabel 0,
    SrvPrivateKeyHint 0,
    SrvShareTitle 1,
    SrvQrTooLong 0,
    SrvImportShareLinks 0,
    SrvImportHint 0,
    SrvImportPasteHint 0,
    SrvParse 0,
    SrvPasteCtrlV 0,
    SrvOkTotal 2,
    SrvValidateAndAddServers 1,
    SrvValidateAndAddServersHint 0,
    SrvValidatingProfiles 1,
    SrvParsingLinks 0,
    SrvImportTooLarge 2,
    SrvParseWorkerFailed 1,
    ...
    SrvShadowsocksMethodRequired 0,
    SrvShadowsocksLevelRange 0,
    SrvAtLeastOneWgPeer 0,
    SrvWgPeerPublicKeyNote 0,
    SrvReservedBytesFound 1,
    SrvResetThreeZeroBytes 0,
    SrvRemovePeer 0,
    SrvAddPeer 0,
    SrvRemove 0,
    ...
    SrvReservedBytes 0,
    SrvPeersColon 0,
    SrvTcpFragmentation 0,
    SrvCustomResponse 0,
    SrvHttpCamouflageHeader 0,
    SrvRequestCamouflage 0,
    SrvResponseCamouflage 0,
    SrvEnableXmux 0,
    SrvSeparateDownlinkStream 0,
    SrvConnectionLimit 0,
    SrvCoreDefaults 0,
    SrvMaxConcurrency 0,
    SrvMaxConnections 0,
    SrvMutuallyExclusive 0,
    SrvDownloadNotAllowed 0,
    SrvRemoveSplitDownload 0,
    SrvDownloadDepth 1,
    SrvUnavailableStreamOne 0,
    SrvDepthExceeded 1,
    SrvSerializationError 1,
    SrvPreservedOverLimit 0,
    SrvSwitchAwayReality 0,
    SrvHysteriaSelectsTls 0,
    SrvHysteriaRequiresTls 0,
    SrvSwitchToTls 0,
    SrvUseVersion2 0,
    SrvRewriteHost 0,
    SrvSkipTlsVerify 0,
    ...
    SrvMinVersionExceedsMax 0,
    SrvComputePinFromCert 0,
    SrvComputePinHint 0,
    SrvProbeTlsCertificate 0,
    SrvProbeTlsHandshake 0,
    SrvProbeTlsHint 0,
    SrvProbeQuicHandshake 0,
    SrvProbeQuicHint 0,
    SrvTlsProbeDomainRequired 0,
    SrvTlsProbeIpInvalid 0,
    SrvTlsProbeRunning 0,
    SrvQuicProbeDomainInvalid 1,
    SrvQuicProbeResolveFailed 1,
    SrvQuicProbeHandshakeFailed 1,
    SrvQuicProbeTimeout 0,
    SrvQuicProbeNoCert 0,
    SrvLeafPin 0,
    SrvCaPins 0,
    SrvCopyPin 0,
    SrvApplyPin 0,
    ...
    SrvPinCaution 0,
    SrvProbeNoPin 0,
    SrvShowProbeOutput 0,
    SrvProbeOutputTitle 0,
    SrvUseServerAddress 0,
    SrvUseServerName 0,
    SrvFromMitmOnlyAlpn 0,
    SrvCustomCertificate 0,
    SrvCertificateN 1,
    ...
    SrvNoiseN 1,
    SrvAddNoise 0,
    SrvMinecraftProfileN 1,
    SrvAddMinecraftProfile 0,
    SrvCertificatePem 0,
    SrvKeyPem 0,
    SrvAddRealmTlsCertificate 0,
    SrvRealmTlsWireNote 0,
    SrvAllowInsecureRemoved 0,
    SrvUnknownFutureFinalmask 1,
    SrvPreservedRawValue 0,
    SrvSetLabel 1,
    SrvLabelSyntax 1,
    SrvUp 0,
    SrvDown 0,
    ...
    SrvEchSockoptNote 0,
    SrvHappyEyeballs 0,
    SrvAddCustomSockopt 0,
    SrvUseDefault 0,
    SrvHostReserved 0,
    SrvWsHostDeprecated 0,
    SrvMoveHostToHost 0,
    SrvRemoveLegacyHost 0,
    SrvUnset 0,
    SrvDefault 0,
    SrvTrueEnable 0,
    SrvFalseDisable 0,
    SrvNumericWindow 0,
    SrvInvalidImportedValue 0,
    SrvPreserved 1,
    SrvWindow 0,
    SrvBrowse 0,
    ...
    SrvTabMux 0,
    SrvTabAdvanced 0,
    CoreSetupVersionLink 1,
    RoutingOverrideApplied 1,
    RoutingOverrideCleared 0,
    SrvNewDraftName 1,
    SrvAddTransformArgument 0,
    SrvProtocolSettingsMismatch 0,
    SrvVlessIdUuid 0,
    SrvVlessEncryptionInvalid 0,
    SrvVlessReverseTagRequired 0,
    SrvVmessIdUuid 0,
    SrvVmessSecurityUnsupported 0,
    SrvShadowsocksLevelRangeShort 0,
    SrvWgSecretInvalid 0,
    SrvWgReservedThreeBytes 0,
    SrvWgAtLeastOnePeer 0,
    SrvWgPeerPublicKeyRequired 0,
    ...
    SrvBlackholeResponseInvalidShort 0,
    SrvDnsRuleActionInvalidShort 0,
    SrvLoopbackTagRequired 0,
    SrvHysteriaVersion 0,
    SrvRealityRequiresTransport 0,
    SrvHysteriaTransportTls 0,
    SrvXhttpSettingsMissing 0,
    SrvKcpSettingsMissing 0,
    SrvGrpcSettingsMissing 0,
    ...
    SrvTlsSettingsMissing 0,
    SrvSendThroughInvalidShort 0,
    SrvNetwork 0,
    SrvSecurity 0,
    SrvName 0,
    SrvGenerateUuidHint 0,
    SrvGenerateVlessencHint 0,
    SrvGenerateWgHint 0,
    SrvGenerateMldsa65Hint 0,
    SrvRandomHexHint 0,
    SrvHysteria2RequiresTls 0,
    SrvHysteria2RequiresTlsSelectBelow 0,
    SrvOnlyHysteria2 0,
    SrvMasquerade 0,
    SrvUseAuto 0,
    ...
    SrvUplinkCapacity 0,
    SrvCwndMultiplier 0,
    SrvMaxSendingWindow 0,
    SrvIdleTimeoutS 0,
    SrvHealthCheckTimeoutS 0,
    SrvHeartbeatPeriodS 0,
    SrvAuthPassword 0,
    SrvUdpIdleTimeoutS 0,
    SrvStatusCode 0,
    SrvServerNameSni 0,
    SrvMinVersion 0,
    SrvMaxVersion 0,
    SrvShowDebug 0,
    SrvOfficialSourceToken 0,
    SrvConcurrencyLegacy 0,
    SrvDelayMs 0,
    SrvBlockDelayMs 0,
    SrvIntervalS 0,
    SrvReverseTag 0,
    ...
    SrvRewriteNetwork 0,
    SrvInboundTag 0,
    SrvCertificateFile 0,
    SrvKeyFile 0,
    SrvPublicKeyPassword 0,
    SrvTcpKeepAliveIdleS 0,
    SrvTcpKeepAliveIntervalS 0,
    SrvPenetrateInherit 0,
    SrvPenetrateDownloadOnly 0,
    SrvCustomTablesLegacy 0,
    SrvLengthsPrecedence 0,
    SrvDelaysPrecedence 0,
    SrvOcspStaplingS 0,
    SrvDomainsServer 0,
    ...
    SrvRewriteAddress 0,
    SrvHKeepAlivePeriodS 0,
    SrvDownlinkCapacity 0,
    SrvCipherSuites 0,
    SrvCurvePreferences 0,
    SrvServerNameTarget 0,
    SrvWgAllowedIps 0,
    ...
    SrvCustomOptHint 0,
    SrvVlessEncryptionHint 0,
    SrvVlessReverseTagHint 0,
    SrvShadowsocksPasswordHint 0,
    SrvSecretKeyHint 0,
    SrvWgPeerPublicKeyHint 0,
    SrvPacketsHint 0,
    SrvBlackholeDataHint 0,
    SrvDnsRuleQTypeHint 0,
    SrvAlpnHint 0,
    SrvCipherSuitesHint 0,
    SrvPinnedPeerCertSha256Hint 0,
    SrvTlsProbeDomainHint 0,
    SrvEchConfigListHint 0,
    SrvRealityPublicKeyHint 0,
    SrvShortIdHint 0,
    SrvMldsa65VerifyHint 0,
    SrvSendThroughHint 0,
    SrvNoisePacketHint 0,
    SrvMetadataSelectorHint 0,
    SrvUdpHopRemoteIpsHint 0,
    SrvXmcPasswordHint 0,
    SrvXmcTexturesValueHint 0,
    SrvXmcTexturesSignatureHint 0,
    SrvMaskPacketsHint 0,
    ...
    SockoptDomainStrategyInvalid 0,
    SockoptAddressPortStrategyInvalid 0,
    SockoptTcpFastOpenType 0,
    SockoptKeepaliveSigns 0,
    SockoptCustomOptRequired 0,
    SockoptCustomTypeInvalid 0,
    OutboundVisionRequiresTls 0,
    OutboundPublicVlessNeedsTls 0,
    OutboundPublicTrojanNeedsTls 0,
    ListenAddressInvalid 0,
    // Configuration-warning messages (Severity::Warning codes).
    OutboundMuxWithVisionFlow 0,
    OutboundServerNameImplausible 0,
    // Protocol-settings vocabulary / required-value messages (outbound
    // `settings` model rules).
    OutboundVlessFlowUnsupported 0,
    OutboundVlessEncryptionUnsupported 0,
    OutboundShadowsocksMethodUnsupported 0,
    OutboundShadowsocks2022KeyInvalid 0,
    OutboundTrojanSettingsIncomplete 0,
    OutboundShadowsocksSettingsIncomplete 0,
    OutboundSettingsPortZero 0,
    OutboundSettingsIdNotUuid 0,
    // Transport-security format rules (stream TLS/REALITY blocks).
    OutboundRealityPublicKeyInvalid 0,
    OutboundRealityShortIdInvalid 0,
    OutboundRealitySpiderXInvalid 0,
    OutboundRealityMldsa65Invalid 0,
    OutboundTlsFingerprintUnsupported 0,
    OutboundRealityFingerprintUnsupported 0,
    OutboundRealityFingerprintUntested 1,
    OutboundPinnedPeerCertSha256Invalid 0,
    OutboundTlsVersionRangeInvalid 0,
    ...
    SrvXhttpModeUnsupported 0,
    SrvXhttpPaddingBytesInvalid 0,
    SrvXhttpPaddingPlacementInvalid 0,
    SrvXhttpPaddingMethodInvalid 0,
    SrvXhttpUplinkPlacementInvalid 0,
    SrvXhttpUplinkPlacementPacketUp 0,
    SrvXhttpUplinkMethodPacketUp 0,
    SrvXhttpSessionPlacementInvalid 0,
    SrvXhttpSeqPlacementInvalid 0,
    SrvXhttpSessionLengthRequired 0,
    SrvXhttpSessionTableInvalid 0,
    SrvXhttpXmuxExclusive 0,
    XhttpExtraShadowsSettings 1,
    SniffingDestOverrideInvalid 0,
    OutboundTargetStrategyInvalid 0,
    SockoptTproxySilentOff 0,
    KcpRangeSoft 0,
    ...
    /// tier, model).
    XhttpServerMaxHeaderBytesInvalid 0,
    GrpcNegativeClamp 0,
    ...
    OutboundMuxXudpProxyUdp443Unsupported 0,
    OutboundMuxConcurrencyReinterpreted 0,
    OutboundMuxXudpKnobsInert 0,
    FinalmaskQuicCongestionInvalid 0,
    FinalmaskQuicBbrProfileInvalid 0,
    FinalmaskQuicBandwidthTooSmall 0,
    FinalmaskQuicBandwidthSyntax 0,
    FinalmaskQuicBandwidthNonFinite 0,
    FinalmaskQuicBandwidthTooLarge 0,
    FinalmaskQuicBandwidthUnitInvalid 1,
    FinalmaskQuicForceBrutalNeedsUp 0,
    ...
    FinalmaskQuicKeepAlivePeriodInvalid 0,
    FinalmaskQuicMaxIncomingStreamsInvalid 0,
    FinalmaskPortNumberRange 0,
    FinalmaskPortEnvNameRequired 0,
    FinalmaskPortListInvalid 1,
    FinalmaskBytesValueRequired 1,
    FinalmaskArrayByteSyntax 0,
    FinalmaskStrByteSyntax 0,
    FinalmaskHexByteSyntax 0,
    FinalmaskBase64ByteSyntax 0,
    FinalmaskUnknownByteSyntax 1,
    FinalmaskTransformOpRequired 0,
    FinalmaskTransformArgRequired 0,
    FinalmaskTransformArgExclusive 0,
    FinalmaskVarNameInvalid 0,
    FinalmaskCustomItemExclusive 0,
    FinalmaskRandRangeInvalid 0,
    FinalmaskXmcProfilesRequired 0,
    FinalmaskXmcPasswordRequired 0,
    FinalmaskXmcUsernameInvalid 0,
    FinalmaskXmcUuidInvalid 0,
    FinalmaskXmcTexturesRequired 0,
    FinalmaskPacketsFirstNotZero 0,
    FinalmaskPacketsSyntax 0,
    FinalmaskLengthsStartAboveZero 0,
    FinalmaskUnknownTcpMask 1,
    ...
    FinalmaskRealmTokenBeforeAt 0,
    FinalmaskRealmIdInPath 0,
    FinalmaskRealmUrlSyntax 1,
    FinalmaskRealmStunRequired 0,
    FinalmaskRealmStunFormat 0,
    FinalmaskRealmAllowInsecureRemoved 0,
    FinalmaskRealmFingerprintUnknown 0,
    FinalmaskRealmAlpnFromMitm 0,
    FinalmaskRealmCertRequired 0,
    FinalmaskRealmEchKeysBase64 0,
    FinalmaskUnknownUdpMask 1,
    // Dashboard: listener traffic + sys-stats surface.
    DashboardMemory 4,
    DashboardInboundTraffic 0,
    DashboardInboundNoListener 0,
    GridUp 0,
    GridDown 0,
    GridType 0,
    ...
    TrialRulesInject 0,
    TrialRulesRemove 0,
    TrialRulesClearAll 0,
    TrialRulesEmpty 0,
    TrialRulesNotRunning 0,
    TrialRuleTagTaken 0,
    TrialRuleTagRequired 0,
    TrialRuleTargetRequired 0,
    TrialRuleNeedsCondition 0,
    TrialRuleTargetNotLive 1,
    TrialRuleAddedUnlisted 0,
    TrialRuleCodeUnknown 1,
    TrialRulesPending 0,
    TrialRulesRefresh 0,
    TopbarTrialRules 1,
    // Dashboard: traffic units + session totals.
    DashboardTrafficUnits 0,
    TrafficUnitAuto 0,
    TrafficUnitBps 0,
    TrafficUnitKiBps 0,
    TrafficUnitMiBps 0,
    ...
    OutboundTrojanFlowRemoved 0,
    KcpSeedHeaderRemoved 0,
    KcpHeaderTypeIgnored 0,
    OutboundVmessAlterIdIgnored 0,
    ...
    SettingsActiveProfileMissing 1,
    SettingsActiveProfileAmbiguous 2,
    SettingsProfilesRequired 0,
    SettingsProfileIdEmpty 1,
    SettingsProfileIdDuplicated 3,
    SettingsProfileTagEmpty 2,
    SettingsProfileTagInvalid 3,
    SettingsProfileTagReserved 3,
    SettingsProfileTagDuplicated 5,
    SettingsOutboundChainMissing 2,
    SettingsOutboundChainCycle 1,
    SettingsBalancerNoTag 1,
    SettingsBalancerNoSelector 1,
    SettingsBalancerTagDuplicated 1,
    SettingsBalancerFallbackMissing 2,
    SettingsLocalInboundPortZero 1,
    SettingsInboundTagDuplicated 1,
    SettingsDokodemoTagMissing 1,
    SettingsDokodemoNetworkInvalid 2,
    SettingsDokodemoUnixSocketRequired 1,
    ...
    RtPhaseBackendReplacementCancelled 0,
    RtPhaseUpdateRecoveryFailed 0,
    RtPhaseApiListenerReadFailed 0,
    RtPhaseConfigReadFailed 0,
    RtPhaseCoreSpawnFailed 0,
    RtPhaseHelperExitUnconfirmed 0,
    RtPhaseConfigError 0,
    RtPhaseReadinessTimeout 1,
    RtPhaseRestartCancelled 0,
    RtFrameCandidateExited 2,
    RtFrameUpdatedCoreExited 2,
    ...
    ProbeExitNoStatus 0,
    ProbeWaitFailed 1,
    ProbeInterfaceTunSelf 1,
    ProbeInterfaceDown 1,
    ProbeInterfaceMissing 1,
    ProbeHostBlocked 1,
    ProbePortAllocateFailed 1,
    ProbePortReadFailed 1,
    ProbeConfigRejected 1,
    ProbeTempDirFailed 1,
    ProbeConfigSerializeFailed 1,
    ProbeConfigWriteFailed 1,
    ProbeChildLaunchFailed 1,
    ProbeNoProfiles 0,
    ProbeCancelled 1,
    ProbeTimedOut 1,
    ProbeTimedOutMissing 2,
    ProbeTimedOutApiError 2,
    ProbeTimedOutMissingApiError 3,
    ProbeDiagnosticsWall 0,
    ShellXrayArchiveFilter 0,
    ShellMasterKeyLogFileName 0,
    ShellCertificateFilter 0,
    // Error chains and runtime messages, rendered at the display boundary.
    LinkPercentTruncated 1,
    LinkPercentEscape 1,
    LinkPercentUtf8 1,
    LinkQueryDuplicate 1,
    LinkNameTooLong 1,
    LinkHostMissing 1,
    LinkHostIdn 1,
    LinkHostInvalid 2,
    LinkHostIpv4 2,
    LinkHostIpv6 2,
    LinkHostIpv6Brackets 1,
    LinkHostBracketed 1,
    LinkHostIpv6Unbracketed 1,
    LinkPortMissing 1,
    LinkPortInvalid 2,
    LinkPortZero 1,
    LinkUuidInvalid 2,
    ...
    LinkNumericParam 2,
    LinkQueryEmpty 1,
    LinkTransportUnknown 1,
    LinkSecurityUnknown 1,
    LinkRealityMldsaDuplicate 0,
    LinkGrpcModeUnknown 1,
    LinkXhttpModeUnknown 1,
    LinkXhttpExtraJson 1,
    LinkXhttpExtraObject 0,
    LinkXhttpExtraReserved 1,
    LinkFinalmaskJson 1,
    LinkUserinfoMissing 1,
    LinkUserinfoAt 1,
    LinkVmessBase64 0,
    LinkVmessJson 1,
    LinkVmessObject 0,
    LinkLegacyFieldType 1,
    LinkVmessAdd 0,
    LinkVmessPort 1,
    LinkVmessTcpType 1,
    LinkVmessNet 1,
    LinkTrojanPasswordEmpty 0,
    LinkSsUserinfoAt 0,
    LinkSsBase64 0,
    LinkSsUtf8 0,
    LinkSsUserinfoFormat 0,
    LinkSsMethodEmpty 0,
    LinkSsPasswordEmpty 0,
    LinkRealityServerNameEmpty 0,
    LinkRealityFingerprint 1,
    LinkRealityPbk 0,
    LinkRealitySid 0,
    LinkRealityPqv 0,
    LinkRealitySpx 0,
    LinkTlsFingerprint 1,
    LinkTlsAlpnFromMitm 0,
    LinkTlsPcs 0,
    LinkXhttpMode 1,
    LinkXhttpHeaderValues 0,
    LinkXhttpHostHeader 0,
    LinkXhttpPaddingBytes 0,
    LinkXhttpPaddingPlacement 0,
    LinkXhttpPaddingMethod 0,
    LinkXhttpUplinkPlacement 0,
    LinkXhttpUplinkMode 0,
    LinkXhttpUplinkMethod 0,
    LinkXhttpSessionPlacement 0,
    LinkXhttpSeqPlacement 0,
    LinkXhttpSessionLength 0,
    LinkXhttpSessionSpace 0,
    LinkXhttpServerMaxHeader 0,
    LinkXhttpXmux 0,
    LinkXhttpStreamOne 0,
    LinkRawHeaderType 1,
    LinkRawCamouflage 0,
    LinkRawHeaderValues 0,
    LinkKcpMtu 0,
    LinkKcpTti 0,
    LinkKcpCwnd 0,
    LinkKcpWindow 0,
    LinkWsHeaderValues 0,
    LinkGrpcServiceName 0,
    LinkHttpupgradeHeaderValues 0,
    LinkProtocolMismatch 2,
    LinkVlessFlow 1,
    LinkVlessEncryption 1,
    LinkTrojanIncomplete 0,
    LinkSsIncomplete 0,
    LinkSsMethod 1,
    LinkSsKeyMaterial 0,
    LinkTooLong 2,
    LinkNoScheme 1,
    LinkBadScheme 1,
    LinkSubscriptionTooLarge 2,
    LinkFinalmaskInvalid 1,
    LinkUnsupportedTypeHttp 0,
    LinkUnsupportedTypeQuic 0,
    LinkUnsupportedXtls 0,
    LinkUnsupportedTrojanEncryption 0,
    ...
    LinkUnsupportedVmessTls 1,
    LinkUnsupportedVmessTcpHostPath 0,
    LinkUnsupportedVmessKcp 0,
    LinkUnsupportedVmessWebsocket 1,
    LinkUnsupportedVmessHttpupgrade 1,
    LinkUnsupportedVmessXhttp 1,
    LinkUnsupportedVmessNetHttp 0,
    LinkUnsupportedVmessNetQuic 0,
    LinkUnsupportedSsPlugin 0,
    LinkUnsupportedSsQueryField 1,
    ...
    LinkLossyVlessExtra 1,
    LinkLossyVmessExtra 1,
    LinkLossyTrojanExtra 1,
    LinkLossySsExtra 1,
    LinkLossyVmessExperiments 1,
    LinkLossyTlsAdvanced 1,
    LinkLossyRealityAdvanced 1,
    LinkLossySockopt 1,
    LinkLossyStreamExtra 1,
    LinkLossyTlsMissing 1,
    LinkLossyRealityMissing 1,
    LinkLossyTlsUnselected 1,
    LinkLossyRealityUnselected 1,
    LinkLossyRawCamouflage 1,
    LinkLossyKcp 1,
    LinkLossyWs 1,
    LinkLossyGrpc 1,
    LinkLossyHttpupgrade 1,
    LinkLossyTransportUnselected 1,
    LinkLossySsStream 1,
    LinkLossyProfileExtra 1,
    LinkLossyDialerProxy 1,
    LinkLossySendThrough 1,
    LinkLossyTargetStrategy 1,
    LinkLossyMux 1,
    LinkLossyOutboundExtra 1,
    LinkLossyProfileName 1,
    LinkLossyProfileRoundtrip 1,
    LinkLossyXhttpSerialize 2,
    LinkLossyXhttpEncode 2,
    LinkLossyFinalmaskEncode 2,
    GenRawOverride 1,
    GenApiListenerPortZero 0,
    GenProbePortZero 0,
    GenProbeUrlInvalid 1,
    GenProbeUrlNotAbsolute 0,
    GenObservatoryProbeHostBlocked 1,
    GenProbeHostBlocked 1,
    GenApiPort 1,
    IntegrityBalancerMissing 1,
    IntegrityBalancerTagEmpty 0,
    IntegrityBalancerTagDuplicate 1,
    IntegrityBalancerReferenced 2,
    IntegrityRuleTargetRequired 0,
    IntegrityRuleTargetExclusive 0,
    IntegrityRouteTargetRequired 0,
    IntegrityRouteTargetPort 0,
    IntegrityRoutePort 1,
    IntegrityRouteIp 2,
    ...
    RtFrameCandidateWriteFailed 0,
    RtFrameApplyCaptureFailed 0,
    RtFrameApplyCommitFailed 0,
    ...
    RtFrameStageCheckingRelease 0,
    RtFrameStageVerifyingArchive 0,
    RtFrameArchiveWorkerFailed 0,
    RtFrameCandidateLostHelper 0,
    RtFrameUpdatedCoreLostHelper 0,
    RtFrameApiListenerNotOwned 0,
    RtFrameApiProbeFailed 1,
    RtReasonStopRequested 0,
    RtReasonShutdownRequested 0,
    RtReasonGuiChannelClosed 0,
    RtReasonCoreExitedUnexpectedly 0,
    ...
    OperationUpdateCore 0,
    OperationLatencyProbe 0,
    OperationValidateProfiles 0,
    SeatRuntimeStopping 0,
    SeatCoreNotRunning 0,
    SeatBalancerTagRequired 0,
    SeatOverrideTargetRequired 0,
    SeatRuleTagRequired 0,
    SeatInvalidRouteTest 0,
    SeatInvalidTrialRule 0,
    SeatBusyWithOperation 1,
    SeatValidationCancelled 0,
    GrpcTestRouteFailed 1,
    GrpcBalancerInfoFailed 1,
    GrpcBalancerInfoMissing 0,
    GrpcBalancerNotFound 1,
    GrpcBalancerOverrideFailed 1,
    GrpcBalancerOverrideClearFailed 1,
    GrpcRestartLoggerFailed 1,
    GrpcAddRuleFailed 1,
    GrpcRemoveRuleFailed 1,
    GrpcListRulesFailed 1,
    GrpcRuntimeStateFailed 1,
    GrpcTrialRuleTagRequired 0,
    GrpcTrialRuleFieldUnsupported 1,
    GrpcTrialRuleTargetRequired 0,
    GrpcTrialRuleTargetConflict 0,
    GrpcGeodataSyntaxError 0,
    GrpcGeodataEmptyFile 0,
    GrpcGeodataEmptyAttr 0,
    GrpcGeodataEmptyCode 0,
    GrpcDotlessRuleContainsDot 0,
    GrpcUnsupportedAddressFamily 0,
    GrpcInvalidCidrPrefix 1,
    GrpcCidrPrefixTooLong 2,
    GrpcInvalidRouteIp 2,
    GrpcUnsupportedNetwork 1,
    // Error chains and runtime messages, rendered at the display boundary.
    HelperPipeIdInvalid 0,
    HelperParentArgMissing 0,
    HelperParentArgDuplicate 0,
    HelperParentArgInvalid 0,
    HelperProcessOpenFailed 1,
    HelperProcessTimeReadFailed 1,
    HelperParentExitedBeforeConnect 0,
    HelperConnectTimeout 0,
    HelperConnectFailed 1,
    HelperParentOpenFailed 0,
    HelperParentExitedBeforePipe 0,
    HelperParentTimeReadFailed 0,
    HelperParentTokenOpenFailed 0,
    HelperParentSidReadFailed 0,
    HelperOwnTokenOpenFailed 0,
    HelperOwnSidReadFailed 0,
    HelperWellKnownSidFailed 0,
    HelperPipeAttributesFailed 0,
    HelperPipeCreateFailed 0,
    HelperPipeModeFailed 0,
    HelperClientPidReadFailed 0,
    HelperClientTimeReadFailed 0,
    HelperClientNotLaunchingGui 0,
    HelperPipeDuplicateFailed 0,
    HelperAuthReadFailed 0,
    HelperAuthMessageMissing 0,
    HelperAuthParseFailed 0,
    HelperAuthRejected 0,
    HelperAuthTimeout 0,
    HelperPipeClosed 0,
    HelperAuthTokenInvalid 0,
    HelperParentPidInvalid 0,
    HelperConnectCancelled 0,
    HelperClientPipeModeFailed 0,
    HelperPipeWriterPoisoned 0,
    HelperAuthWriteFailed 0,
    HelperAuthFlushFailed 0,
    HelperReaderThreadFailed 0,
    HelperStartPortInvalid 0,
    HelperStartCorePathNotAbsolute 0,
    HelperPipeWriteFailed 0,
    HelperPipeFlushFailed 0,
    HelperProgramDataResolveFailed 0,
    HelperProgramDataDecodeFailed 0,
    HelperProgramDataInspectFailed 1,
    HelperProgramDataNotDirectory 0,
    HelperDirectoryInspectFailed 1,
    HelperDirectoryNotOrdinary 0,
    HelperDescriptorSizeQueryFailed 0,
    HelperDescriptorReadFailed 0,
    HelperDescriptorControlReadFailed 0,
    HelperOwnerReadFailed 0,
    HelperDaclReadFailed 0,
    HelperDaclMissingOrInherited 0,
    HelperOwnerUnexpected 0,
    HelperDaclMissing 0,
    HelperDaclUnexpectedPrincipals 1,
    HelperAceReadFailed 0,
    HelperAceMalformed 0,
    HelperAceNotFullControl 0,
    HelperAceSystemRepeated 0,
    HelperAceAdministratorsRepeated 0,
    HelperAceUnexpectedSid 0,
    HelperAcePrincipalMissing 0,
    HelperDeviationNotBenign 0,
    HelperDescriptorBuildFailed 0,
    HelperDaclRepairFailed 0,
    HelperDirectoryAttributesFailed 0,
    HelperDirectoryCreateFailed 1,
    HelperStageEnumerateFailed 1,
    HelperStageEntryReadFailed 0,
    HelperStageEntryInspectFailed 1,
    HelperStageEntryUnexpected 0,
    HelperStageMarkerMissing 0,
    HelperStageEntryRemoveFailed 1,
    HelperStageRemoveFailed 1,
    HelperStagedConfigCreateFailed 1,
    HelperStagedConfigWriteFailed 0,
    HelperStagedConfigFlushFailed 0,
    HelperStagedConfigLockFailed 1,
    HelperStagedConfigProofFailed 0,
    HelperStageMarkerCreateFailed 1,
    HelperStageMarkerWriteFailed 0,
    HelperStageMarkerFlushFailed 0,
    HelperHashRewindFailed 0,
    HelperHashReadFailed 0,
    HelperWirePathMissing 0,
    HelperWirePathLengthInvalid 0,
    HelperWirePathUnitInvalid 0,
    HelperWirePathNul 0,
    HelperWirePathNotAbsolute 0,
    HelperWireConfigMissing 0,
    ...
    HelperStagedValidationTimeout 0,
    HelperStagedValidationWaitFailed 0,
    ApplyActiveReadFailed 0,
    ApplyListenMissing 0,
    ApplyListenInvalid 1,
    ApplyListenNotLoopback 1,
    ApplyFileReadFailed 1,
    ApplyFileParseFailed 1,
    ApplyValidationSpawnFailed 0,
    ApplyValidationChildExited 0,
    ApplyValidationJobCreateFailed 0,
    ApplyValidationJobAssignFailed 0,
    ApplyFilesystemWorkerFailed 0,
    ApplyConfigDirCreateFailed 0,
    ApplyCandidateSerializeFailed 0,
    ApplyFileCreateFailed 1,
    ApplyFileWriteFailed 1,
    ApplyFileFlushFailed 1,
    ApplyLastgoodStageFailed 0,
    ApplyLastgoodReplaceFailed 0,
    ApplyActiveReplaceFailed 0,
    ApplyRollbackMissing 0,
    ApplyRollbackStageFailed 0,
    ApplyRollbackRestoreFailed 0,
    ApplyValidationTimeout 1,
    ApplyValidationRunFailed 0,
    ApplyCoreVerifyFailed 0,
    ApplyCoreVerifyWorkerFailed 0,
    SupervisorVerifyFailed 0,
    SupervisorVerifyWorkerFailed 0,
    SupervisorSpawnFailed 0,
    ...
    CoreDlPayloadFlushFailed 1,
    CoreDlPayloadLockFailed 1,
    CoreDlPayloadProofFailed 3,
    CoreDlCorePathNotAbsolute 0,
    CoreDlSourceInspectFailed 1,
    CoreDlSourceNotDirectory 1,
    CoreDlSourceNotFile 1,
    CoreDlMetadataOpenFailed 1,
    CoreDlMetadataParseFailed 1,
    CoreDlMetadataMismatch 0,
    CoreDlPayloadOpenFailed 1,
    CoreDlPayloadVerifyFailed 3,
    CoreDlPayloadStillDrifted 3,
    CoreDlPayloadRestoreFailed 3,
    CoreDlVersionPrefixMissing 0,
    CoreDlVersionInvalid 0,
    CoreDlArchivePinInvalid 0,
    CoreDlArchiveMismatch 2,
    CoreDlStageDownload 0,
    CoreDlStageVerifyPin 0,
    CoreDlStageInstall 0,
    CoreDlHttpRequestFailed 1,
    CoreDlHttpStatusRejected 1,
    CoreDlDownloadTooLarge 3,
    CoreDlDownloadTimeout 2,
    CoreDlDownloadStreamFailed 0,
    CoreDlDownloadSizeOverflow 0,
    CoreDlDownloadLimitExceeded 2,
    CoreDlDownloadWriteFailed 1,
    CoreDlDownloadFlushFailed 1,
    CoreDlDirectoryCreateFailed 1,
    CoreDlFileOpenFailed 1,
    CoreDlFileCreateFailed 1,
    CoreDlFileWriteFailed 1,
    CoreDlFileFlushFailed 1,
    CoreDlFileRemoveFailed 1,
    CoreDlFileCopyFailed 1,
    CoreDlFileReplaceFailed 2,
    CoreDlHashingFailed 0,
    CoreDlMetadataSerializeFailed 0,
    CoreDlArchiveOpenFailed 1,
    CoreDlArchiveInvalid 0,
    CoreDlArchiveEntryUnreadable 1,
    CoreDlArchiveExtractFailed 1,
    CoreDlArchiveMissingXray 0,
    CoreDlArchivePayloadsMismatch 0,
    CoreDlPristineCopyFailed 2,
    CoreDlPristineMismatch 3,
    CoreDlRestoreUnavailable 1,
    CoreDlCoreNotDirectory 0,
    CoreDlBackupNotDirectory 0,
    CoreDlRecoverBackupFailed 0,
    CoreDlMarkerCorrupt 0,
    CoreDlRecoverInterruptedFailed 0,
    CoreDlInterruptedWithoutCore 0,
    CoreDlUpdatePendingHealth 0,
    CoreDlBackupRemoveFailed 0,
    CoreDlQuarantineFailed 0,
    CoreDlRestoreLastgoodFailed 0,
    CoreDlRestoreCandidateFailed 0,
    CoreDlStagingMissing 0,
    CoreDlBackupStagingFailed 0,
    CoreDlInstallFailed 0,
    CoreDlRestoreAfterValidationFailed 0,
    HelperLaunchDeclined 0,
    HelperShellExecuteFailed 1,
    HelperLaunchExePathFailed 1,
    HelperTokenFileOwnerFailed 1,
    HelperTokenFileCreateFailed 1,
    HelperTokenFileSecurityFailed 1,
    HelperTokenFileWriteFailed 1,
    GeodataErrorIo 3,
    GeodataErrorTooLarge 3,
    GeodataErrorMalformed 3,
    GeodataOperationOpen 0,
    GeodataOperationInspect 0,
    GeodataOperationRead 0,
    DashboardLatencyNoObservation 0,
    SrvBlackholeCustomDataInvalid 0,
    SrvRealmIpModeNote 0,
    SrvRealmPortMappingNote 0,
    SrvTimeoutS 0,
    SrvLifetimeS 0,
    SrvXForwarded 0,
    SrvXForwardedNote 0,
...
///   template — the count [`Key::arity`] declares — and a mismatch panics in
///   debug builds. `{{`/`}}` escapes are not supported and none exist in the
///   locale table.
/// - Arguments beyond the placeholder count are ignored (the debug assertion
///   catches that as a bug anyway).
///
/// Every fill of a locale string's placeholders goes through here, or through
/// [`fill_message_template`] when the template comes from [`validation_message`]
/// or [`safety_message`] instead of [`t`].
...
/// Fill one locale template that did not come through [`t`] —
/// [`validation_message`] and [`safety_message`] return their text directly, so
/// their callers fill the code-carried values here. The placeholder contract is
/// the one [`t_fmt`] asserts: the argument count MUST equal the `{` count of
/// the template, and a mismatch panics in debug builds.
fn fill_message_template(template: &str, args: &[&dyn std::fmt::Display]) -> String {
    debug_assert_eq!(
        args.len(),
        template.matches('{').count(),
        "fill_message_template({template:?}): argument count must equal placeholder count"
    );
    fill_placeholders(template, args)
}
...
mod en {
    ...
    pub(super) fn table(key: Key) -> &'static str {
        match key {
            ...
            Key::SrvWgAllowedIps => "allowed IPs",
            ...
            Key::SrvDialerProxyHint => "outbound tag",
            Key::SrvCustomLevelHint => "numeric socket level",
            ...
            Key::SrvBlackholeDataHint => "base64 (standard alphabet, = padded)",
            Key::SrvDnsRuleQTypeHint => "1,28 or 1-10",
            Key::SrvAlpnHint => "h2, http/1.1",
            Key::SrvCipherSuitesHint => "colon-separated Go names",
            Key::SrvPinnedPeerCertSha256Hint => {
                "comma-separated 32-byte hex pins — replaces allowInsecure"
            }
            Key::SrvTlsProbeDomainHint => "example.com or example.com:8443",
            Key::SrvEchConfigListHint => "base64 ECHConfigList or https://1.1.1.1/dns-query",
            Key::SrvRealityPublicKeyHint => "unpadded base64url X25519 public key",
            Key::SrvShortIdHint => "hex, ≤ 16 chars",
            ...
            Key::SrvUdpHopRemoteIpsHint => "198.51.100.0/24 or 2001:db8::1",
            ...
            Key::SrvMaskPacketsHint => "tlshello, N, or from-to",
